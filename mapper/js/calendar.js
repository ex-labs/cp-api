...
//******************************************************************************
     ...
     document.writeln(
        '<style type="text/css">' +
            '.jacs, .jacsStatic {padding:5px 5px 0;vertical-align:middle;}' +
            'iframe.jacs        {position:absolute;visibility:hidden;top:0px;left:0px;width:1px;height:1px;}' +
            'table.jacs, ' +
            'table.jacsStatic   {padding:0px; visibility:hidden; width:250px; box-shadow:0 0 5px #000000; cursor:default; text-align:center;}' +
    ...
    // This style sheet can be extracted from the script and edited into regular
     ...
     document.writeln(
        '<style type="text/css">' +
            ...
            'table.jacs,' +
            'table.jacsStatic   {padding:0; vertical-align:middle; border:none; font-size:11px; font-weight:normal;}' +
            'td.jacsDrag,' +
            'td.jacsHead                 {padding:0; text-align:center;}' +
            'td.jacsDrag                 {font-size:8pt;}' +
            'select.jacsHead             {margin:3px 1px;}' +
            'input.jacsHead              {height:22px; width:22px; vertical-align:middle; text-align:center; margin:2px 1px; font-weight:bold; font-size:10px; font-family:fixedSys;}' +
            'td.jacsWeekNumberHead,' +
            'td.jacsWeek                 {padding:0px; text-align:center; font-weight:bold;}' +
            'td.jacsNow,' +
            'td.jacsNowHover,' +
            'td.jacsNow:hover,' +
            'td.jacsNowDisabled          {padding:0px; text-align:center; vertical-align:middle; font-size:8pt; font-weight:normal;}' +
            'table.jacsCells             {text-align:right; font-size:12px; width:100%;}' +
            'td.jacsCells,' +
            'td.jacsCellsHover,' +
            'td.jacsCells:hover,' +
            ...
            '/* Calendar background */' +
            'table.jacs,' +
            'table.jacsStatic            {background-color:  #125BAA; margin: 10px 0 0;}' +
            '/* Drag Handle */' +
            ...
            'td.jacsInputDate            {background-color:  #CC9999;' +
                                         'color:             #FF0000;}' +
            '/* Weekend Day */' +
            'td.jacsCellsWeekend         {background-color:  #fff;' +
                                         'color:             #CC6666;}' +
            '/* Day outside the current month */' +
            'td.jacsCellsExMonth         {background-color:  #efefef;' +
                                         'color:             #aaa;}' +
            '/* Today selector */' +
            'td.jacsNow                  {background-color:  #FF0000;' +
                                         'color:             #FFFFFF;}' +
             ...
             default:
                ...
                try   {jacsSetLanguage(cal);}
                    ...
                    {// English
                     ...
                     cal.clear               = 'Clear';
                     cal.drag                = 'click here to drag';
                     cal.monthNames          = ['January','February','March','April','May','June',
                                                'July','August','September','October','November','December'];
                     cal.weekInits           = ['Sun','Mon','Tue','Wed','Thu','Fri','Sat'];
                     cal.invalidDateMsg      = 'The entered date is invalid.\n';
                     cal.outOfRangeMsg       = 'The entered date is out of range.';
                     cal.doesNotExistMsg     = 'The entered date does not exist.';
                     cal.invalidAlert        = ['Invalid date (',') ignored.'];
                ...
                cal.dateDisplayFormat = 'DD MMM YYYY'; //'mm/dd/yyyy';     // e.g. 'MMM-DD-YYYY' for the US

                // Output date format

                cal.dateFormat  = 'DD MMM YYYY'; //'mm/dd/yyyy';   //DD-MMM-YYYY'; // e.g. 'MMM-DD-YYYY' for the US
             ...
             make: function (calId)
                {cals.push(calId);
                 ...
                 TABLEjacsCells.appendChild(TFOOTjacsFoot);
                    ...
                    TDjacsFoot.style.padding = '10px 50px';
