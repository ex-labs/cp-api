...
<div class="wrapper">
    ...
    <div class="grad1 rounded module">
        ...
        <div style="width: 560px; padding: 0 0 5px 0; text-align: right;">
		...
		<table class="tablesorter" border="0" cellpadding="0" cellspacing="0" style="width: 560px;">
            <thead>
            <tr>
                <th width="140">Date</th>
                <th width="140">Players</th>
                <th width="140">Acts</th>
...
for($i=0; $i<120; $i++) {
	...
	echo '<tr><td><span style="color:'. $rowbg .'; font-weight:bold;">'. date("m/d/Y", $thisDay) .'</span></td><td>'. number_format($count_players_finish) .'</td><td>'. number_format($count_finished) .'</td><td>'. number_format($acts_player, 2, '.', '') .'</td></tr>';
...
echo '<tr><td><strong>Month Total:</strong></td><td><strong>'. number_format($total_players_finished) .'</strong></td><td><strong>'. number_format($total_finished) .'</strong></td><td><strong>'. number_format($acts_player, 2, '.', '') .'</strong></td></tr>';
?>
